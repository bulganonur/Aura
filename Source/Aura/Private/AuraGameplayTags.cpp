...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(Ability_Fire_FireBlast, "Ability.Fire.FireBlast", "FireBlast Ability");
...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(CoolDown_Fire_FireBlast, "CoolDown.Fire.FireBlast", "FireBlast CoolDown Tag");
